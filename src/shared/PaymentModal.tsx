...
import { Box, Modal, Button, Radio, RadioGroup, FormControlLabel, TextField } from "@mui/material";
    ...
    >
      <Box sx={style}>
        <div className='flex justify-between items-center m-4'>
          <h2 id="modal-title" className='text-xl'>Payment Method</h2>
        ...
        <div className="py-4 mx-auto items-center px-8">
          ...
          <RadioGroup row aria-label="paidWith" name="paidWith" value={paidWith}     onChange={(event)=> setPaidWith(event.target.value)}>
        ...
        {paidWith === 'card' ? (
          ...
          <div className="mx-auto items-center p-8">
            <RadioGroup aria-label="bankType" name="bankType">
              ...
              <FormControlLabel value="salary" control={<Radio />} label="Salary Account" />
            </RadioGroup>
            ...
            <div className="mx-auto items-center p-8">
                ...
                <button className='text-[#006E88] rounded-full border border-gray-500 w-full px-4 py-2 mt-3'>Add new card</button>
